...
<div class="container">
  ...
  <div class="row">
    ...
    <label for="app_size">크기</label>
      <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" name="app_size" id="app_size" placeholder="어플리케이션 크기">
    </div>
  </div>
  <div class="row">
    <div class="col">
  ...
  <button class="btn btn-primary me-md-2" type="button" onclick="register()">등록</button>
