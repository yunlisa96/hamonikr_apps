...
<div class="container">
  ...
  <div class="row">
    ...
    <label for="app_licenses">라이센스</label>
      <input type="text" class="form-control" name="app_licenses" id="app_licenses" placeholder="이름">
    </div>
    <div class="col">
    <label for="app_repository">저장소위치</label>
      <input type="text" class="form-control" name="app_repository" id="app_repository" placeholder="버전">
    </div>
  </div>
</form>
<%-- </main> --%>
